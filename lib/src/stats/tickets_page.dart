...
class TicketsPage extends StatefulWidget {
  ...
  const TicketsPage({super.key, required this.result});
...
class _TicketsPageState extends State<TicketsPage> {
  ...
  Future<void> _loadTickets() async {
    Future.microtask(() async {
      ...
      List<TicketSuccessResponse> cachedTickets = await _loadCachedTickets();
  ...
  Widget build(BuildContext context) {
    List<TicketSuccessResponse>? currentIndexItems =
        results
            ?.where(
              (el) =>
                      ...
                      child: Column(
                        children: [
                          for (
                            ...
                            infoDataCard(
                              price: currentIndexItems?[k].payment?.amount ?? 0,
                              isVerified: true,
                              color: Theme.of(context).primaryColor,
