...
class _HistoryPageState extends State<HistoryPage> {
  ...
  void cacheUserResponse(UserResponse? users) async {
    if (results != null) {
      final usersJsonList = results?.results
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        iconTheme: IconThemeData(color: Colors.black.withValues(alpha: 0.5)),
        centerTitle: false,
        leading: InkWell(
          onTap: () {
    ...
    child: Row(
      ...
      children: [
        ...
        Text(
          displayCount,
          style: TextStyle(
            color: isSearching && filteredList.isEmpty
                ? Colors.red
                : Colors.black,
            fontSize: 16,
    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Image.asset(Assets.email, height: 18, width: 18),
...
class InfoRichText extends StatelessWidget {
  ...
  const InfoRichText({required this.title, required this.value, Key? key})
    : super(key: key);
