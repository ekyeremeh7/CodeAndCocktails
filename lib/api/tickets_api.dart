...
class TicketSingleton {
  ...
  // Singleton instance
  static final TicketSingleton _instance =
      TicketSingleton._();
  ...
  Future<ErrSuccResponse?> verifyMyTicket({String ticketID = ""}) async {
    try {
      ...
      Response response = await dio.get(TicketsUrls.verifyMyTicket + ticketID);
